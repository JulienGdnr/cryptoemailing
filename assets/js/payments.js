...
(async () => {
    ...
    const stripe = Stripe("pk_test_0N16MiLRRTcrfWYcqg7C2kxk");
    ...
    let country = "US"
    countrySelector.querySelector(`option[value=${country}]`).selected =
      'selected';
    countrySelector.className = `field ${country}`;
